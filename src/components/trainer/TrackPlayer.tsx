...
export default function TrackPlayer({
  ...
  return (
    <>
      ...
      {/* Плеер стоит НАД доком управления и, в отличие от него, при листании не
          уезжает: док — контекстные кнопки, которые можно и спрятать, а звук —
          то, ради чего экран открыт. Когда док прячется, плеер съезжает на его
          место, чтобы не висеть посреди экрана в одиночестве. */}
      <motion.div
        initial={false}
        animate={{ marginBottom: collapsed ? 74 : 138 }}
