...
export default function StatsWidget({ columns = 1 }: { columns?: number }) {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      >
        {stats.map(s => (
          <div key={s.label} className="stat-card flex flex-col items-center justify-between rounded-[24px]" style={{ ...cardStyle, textAlign: 'center' }}>
        ...
        {/* Stars card */}
        <div className="stat-card flex flex-col items-center justify-between rounded-[24px]" style={{ ...cardStyle, textAlign: 'center' }}>
