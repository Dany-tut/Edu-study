...
export default function CompactWidgetPill() {
  ...
  //
  // В тренажёре предмет берётся из самого тренажёра. Обычно он совпадает с
  // курсом (выбор языка переводит и курс), но расходится там, где курса нет —
  // язык из ссылки, запасной банк заданий, — и виджеты в шапке должны быть про
  // то, чем ученик занят прямо сейчас.
