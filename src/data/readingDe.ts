...
Пожалуйста, не говорите со мной слишком быстро!`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Polnisch zu sprechen', 'Nichts', 'Langsam zu sprechen', 'Laut zu sprechen'],
        correct: 2,
...
Воскресенье — выходной.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Nur mit Anmeldung', 'Der Aushang sagt es nicht', 'Ja, bis 11 Uhr', 'Nein, sonntags ist geschlossen'],
        correct: 3,
    ...
    questions: [
      {
        ...
        options: ['16:30', '17:00', '16:00', '16:15'],
        correct: 3,
      ...
      },
      {
        ...
        options: ['Ein Getränk', 'Feste Schuhe', 'Eine Regenjacke', 'Süßigkeiten'],
        correct: 3,
...
можно донести позже.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['72 Euro', '60 Euro', '54 Euro', '90 Euro'],
        correct: 1,
