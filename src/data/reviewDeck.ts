...
export interface ReviewCard {
   ...
   * про survivalPhrases и знать не должна, а пример к карточке приходит ещё и
   * из урока курса (см. lib/cardExamples.ts).
   *
   * Перевод необязателен: у примера, добытого из теории урока, его может не
   * быть, и предложение показывается без второй строки.
   */
