    ...
    levels: [
      ...
      },
      {
        ...
        teacherTask: isBiology
          ...
          : {
              topic: 'Мини-кейс: разбор реакции',
              prompt: 'Составь цепочку превращений по теме урока, объясни выбор реагентов и коротко распиши, почему реакция идёт именно так.',
              teacherNote: 'Преподаватель посмотрит ход мысли, оформление уравнений и объяснение каждого шага.',
              placeholder: 'Шаг 1: беру ... потому что ... Далее получаю ...',
