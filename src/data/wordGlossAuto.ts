...
//
// Файл целиком пишет `npm run adapt:feed`: когда конвейер сочиняет пересказ, он
// тут же выписывает КАЖДОЕ слово этого текста, которого ещё нет в словаре тапа.
// Иначе свежий текст ломал бы главную гарантию чтения — «ткни в любое слово и
// получи перевод», — и ломал бы молча.
//
