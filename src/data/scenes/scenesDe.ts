    ...
    questions: [
      {
        ...
        options: ['Dass er krank ist', 'Dass er sich in ein Ungeziefer verwandelt hat', 'Dass er verschlafen hat', 'Dass jemand im Zimmer ist'],
        correct: 1,
      },
      {
      ...
      },
      {
        ...
        options: ['Lehrer', 'Reisender (Handelsvertreter)', 'Arzt', 'Beamter'],
        correct: 1,
        why: 'Прямо в тексте, в скобках: «Samsa war Reisender».',
      },
      {
        q: 'Warum kann Gregor nicht weiterschlafen?',
        options: ['Es ist zu laut draußen', 'Er kann sich nicht auf die rechte Seite drehen', 'Die Schwester ruft ihn', 'Es ist schon Mittag'],
        correct: 1,
      },
    ],
  },
...
И пока она так причитала, кто-то ей крикнул: «Что с тобой, королевна? Ты так кричишь, что и камень бы сжалился». Она огляделась, откуда голос, и увидела лягушонка, высунувшего из воды свою толстую безобразную голову. «Ах, это ты, старый водяной шлёпальщик, — сказала она, — я плачу о моём золотом мяче, который упал в колодец».`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Perfekt', 'Präteritum', 'Plusquamperfekt', 'Futur'],
        correct: 1,
...
Дети от голода тоже не могли заснуть и слышали, что мачеха сказала отцу.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Er ist sofort einverstanden', 'Er weigert sich', 'Er schweigt', 'Er lacht'],
        correct: 1,
      ...
      },
      {
        ...
        options: ['Die Kinder schlafen ein', 'Die Kinder hören alles mit', 'Der Vater geht weg', 'Die Mutter weint'],
        correct: 1,
      },
    ],
  },
...
«Может быть, мама. Но если бы и так — кто виноват? В кого я такая? Только в тебя. Или, по-твоему, в папу? Тут ты и сама рассмеёшься. И потом — зачем ты наряжаешь меня в этот балахон, в этот мальчишеский халат? Иногда мне кажется, что я вот-вот снова окажусь в коротких платьицах. А как только они у меня появятся, я снова начну приседать в реверансе, как девчонка-подросток. Ты виновата. Почему мне не шьют выходных платьев? Почему ты не делаешь из меня даму?»`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Über das Essen', 'Über ihre Kleidung — sie will Erwachsenenkleider', 'Über den Vater', 'Über die Schule'],
        correct: 1,
      ...
      },
      {
        ...
        options: ['Ein harter Streit', 'Ein Verhör', 'Scherzhaft, aber mit einem ernsten Kern', 'Völlig gleichgültig'],
        correct: 2,
      },
    ],
  },
    ...
    questions: [
      {
        ...
        options: ['Auf einem Schiff', 'Auf einem Deich in Nordfriesland', 'In einem Dorf', 'Im Wald'],
        correct: 1,
      },
      {
        q: 'Wie ist das Wetter?',
        options: ['Warm und ruhig', 'Neblig, aber windstill', 'Eiskalter Sturm mit hohen Wellen', 'Leichter Regen'],
        correct: 2,
      },
      {
        q: 'Wen trifft der Erzähler unterwegs?',
        options: ['Einen Bauern', 'Niemanden — keine Menschenseele', 'Eine Gruppe Reiter', 'Einen Fischer'],
        correct: 1,
...
— Понимаю. Поэтому и спрашиваю.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Geld', 'Die Handynummer und ein aktuelles Foto', 'Eine schriftliche Anzeige', 'Den Namen des Vaters'],
        correct: 1,
      },
      {
        q: 'Welche Wörter machen den Dialog gesprochen statt geschrieben?',
        options: ['die Fachbegriffe', 'die Stellung des Verbs', 'die Kurzformen wie „hab“ und die Partikeln „doch“, „mal“', 'die langen Sätze'],
        correct: 2,
...
— Потому что сейчас тихий час, а вы орёте уже десять минут.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Sie brauchen Hilfe', 'Wegen der Ruhezeit und des Lärms', 'Sie bringen ein Paket', 'Sie wollen Glas abholen'],
        correct: 1,
      ...
      },
      {
        ...
        options: ['Wo steht der Müll?', 'Wer hat den Müll gemacht?', 'Wer ist heute an der Reihe?', 'Wann kommt die Müllabfuhr?'],
        correct: 2,
      },
    ],
  },
