// ─────────────────────────────────────────────────────────────────────────────
// Реестр изданий ленты
//
// ВЫНЕСЕН ИЗ index.ts РАДИ ВХОДНОГО ЧАНКА. Реестр — это шестьсот строк данных
// (28 КБ в сборке), и нужен он только там, где рисуют сам пост: в ленте
// тренажёра и в виджете главной. А импортировали data/feed ещё и мобильная
// главная, счётчик непрочитанного в меню и хранилище рубрик — им от модуля
// нужны три функции, но приезжал он целиком, вместе с реестром.
//
// Правовое основание каждого источника (`license`) — часть данных, а не
// украшение: см. шапку index.ts про три дорожки.
// ─────────────────────────────────────────────────────────────────────────────
import type { Lane, OutletKind, Status, FeedTheme } from './index'
