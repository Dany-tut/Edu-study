...
export const OUTLETS: Outlet[] = [
  ...
  {
    id: 'sci-retold-ko',
    name: 'Наука · пересказ', lang: 'ko', lane: 'free', kind: 'science', status: 'live',
    license: 'Наш текст по материалам в общественном достоянии',
    home: 'https://science.nasa.gov/',
    note: 'Научная новость, рассказанная по-корейски на трёх уровнях сразу: от простого к газетному. Исходный материал назван под текстом.',
    mark: '과학', tint: '#3E6E8E',
  },
  {
    id: 'sci-retold-en',
    name: 'Наука · пересказ', lang: 'en', lane: 'free', kind: 'science', status: 'live',
    license: 'Наш текст по материалам в общественном достоянии',
    home: 'https://science.nasa.gov/',
    note: 'Одна и та же научная новость на B1, B2 и C1: не «упрощённый пересказ вместо статьи», а лестница к ней.',
