    ...
    questions: [
      {
        ...
        options: ['A cook', 'A translator', 'A driver', 'A teacher'],
        correct: 1,
      },
      {
        q: 'How does Tomas want you to contact him?',
        options: ['By phone', 'By message here', 'By email', 'In person'],
        correct: 1,
      },
      {
        q: 'Can you arrive at 13:00?',
        options: ['Yes, any time', 'No, check-in is after 15:00', 'Only with a key', 'The text does not say'],
        correct: 1,
      },
    ],
  },
...
Картой принимаем от 5,00, извините.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Coffee', 'Bread', 'Juice', 'Nothing'],
        correct: 1,
      },
    ],
  },
...
Не пользуйтесь ею и не чините сами.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Still in the machine', 'In a basket', 'In your flat', 'With the caretaker’s keys'],
        correct: 1,
      },
      {
...
даже если вы уже прошли досмотр.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['At the gate', 'Online before the flight', 'On the plane', 'The pass does not say'],
        correct: 1,
      },
    ],
  },
...
Банку может понадобиться ещё пара дней, чтобы их показать.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Cash', 'Back to your card', 'As a gift card', 'You cannot return sale items'],
        correct: 2,
      },
      {
    ...
    questions: [
      {
        ...
        options: ['Friday afternoon', 'Overnight', 'Saturday midday', 'Sunday'],
        correct: 1,
      },
      {
...
Сдать сгенерированное как своё — плагиат, и это уходит на комиссию факультета, а не ко мне.`,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Minus 30 points', 'Minus 25 points', 'Zero', 'It depends on the tutor'],
        correct: 2,
      },
      {
        q: 'When should an unfair group workload be raised?',
        options: ['Any time', 'By week eight', 'In week fourteen', 'After the marks come out'],
        correct: 1,
      },
    ],
  },
