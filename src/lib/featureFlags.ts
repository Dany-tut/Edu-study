...
//
// Это флаг УСТРОЙСТВА, а не продукта: он живёт в одном браузере и никому,
// кроме сидящего за ним, ничего не переключает. Рубильник «включить фичу
// всем» — это app_flags в базе (см. lib/cardGroups.ts: appFlag/setAppFlag).
