...
export const DEFAULT_DESKS: Desk[] = [
  {
    ...
    items: [
      { i: 'stat-students',   type: 'stat-students',   x: 0,  y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'stat-hw',         type: 'stat-hw',         x: 3,  y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'stat-lessons',    type: 'stat-lessons',    x: 6,  y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'stat-earnings',   type: 'stat-earnings',   x: 9,  y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
  ...
  },
  {
    ...
    icon: 'wallet',
    items: [
      { i: 'finance-received',  type: 'finance-received',  x: 0, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'finance-expected',  type: 'finance-expected',  x: 3, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'finance-debt',      type: 'finance-debt',      x: 6, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'finance-forecast',  type: 'finance-forecast',  x: 9, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
  ...
  },
  {
    ...
    icon: 'users',
    items: [
      { i: 'student-count',      type: 'student-count',      x: 0, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'student-groups',     type: 'student-groups',     x: 3, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'student-active',     type: 'student-active',     x: 6, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
      { i: 'student-debtors',    type: 'student-debtors',    x: 9, y: 0, w: 3, h: 2, minW: 2, minH: 2, maxH: 3 },
