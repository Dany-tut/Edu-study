...
// (lib/bottomSafe.ts). Пока вилка была широкой (26…34), замер имел смысл. Но
// сама зона домашней полосы (34pt) доку не нужна: полоса тонкая и нарисована
// в 8pt от края, плавающей таблетке хватает 20pt, чтобы её не задеть. С такой
// вилкой измерять стало нечего — число прибито намертво, и док не двигается
// НИ РАЗУ: ни на скелетоне, ни после прокрутки, ни между запусками.
//
