...
// Замер на iPhone 16 Pro (экран 874pt) в установленном PWA:
//   сразу после запуска  innerHeight 812, screen 874 → промах 62
//   после первого свайпа innerHeight 874             → промах 0
// То есть недостача равна верхнему вырезу (62), а не домашней полосе (34) —
// потолок обязан быть выше него с запасом, иначе поправка не срабатывает.
const MAX_SHIFT = 100
